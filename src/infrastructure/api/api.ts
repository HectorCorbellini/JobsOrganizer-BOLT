...
import { IJobService } from '../../application/services/jobService';
import { IResponseService } from '../../application/services/responseService';
import { IImportService } from '../../application/services/importService';

const API_BASE_URL = import.meta.env.VITE_API_URL || '/api';

class ApiService implements IJobService, IResponseService {
...
export const apiService: IJobService & IResponseService & IImportService = new ApiService();